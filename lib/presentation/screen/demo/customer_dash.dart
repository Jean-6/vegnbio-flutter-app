...
import '../customer/my_customer_screen.dart';
...
class _CustomerDashState extends State<CustomerDash> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _pages = [
      _buildHomePage(),
      const Center(child: Text("Member Page")), // TODO: Remplace par ta vraie page
      const Center(child: Text("Communauté Page")), // idem
      MyCustomerScreen(userName: userName ?? '', email: email ?? ''),
    ];
