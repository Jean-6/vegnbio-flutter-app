...
import 'package:vegnbio/presentation/screen/customer/events_screen.dart';
import 'package:vegnbio/presentation/screen/customer/menus_screen.dart';
...
class CustomerDash extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CustomerDashScreen(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class CustomerDashScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _iconBox(Icons.school, "Communauté",(){

                }),
                _iconBox(Icons.menu_book, "Reservations", (){

                }),
                _iconBox(Icons.category, "Menus", (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => MenusScreen()),
                  );
                }),
                _iconBox(Icons.card_giftcard, "Evenements", (){
                  Navigator.push(
                      context,
